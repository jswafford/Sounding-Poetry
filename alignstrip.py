...
def parse_args(argv=None):
    """Parses the command line. If no arguments are given, it will default to a given set of commands."""

    parser = argparse.ArgumentParser(description=__doc__)

    parser.add_argument('-t', '--textgrid', dest='textgrid', action='store',
                        default=NEED_DEFAULT_VALUE_HERE,
                        help='Describes what the argument does. Default = {}.'.format(NEED_DEFAULT_VALUE_HERE))
    parser.add_argument('-w', '--wav', dest='wav',
                        default=NEED_DEFAULT_VALUE_HERE,
                        help='Describes what the argument does = {}'.format(NEED_DEFAULT_VALUE_HERE))
    parser.add_argument('-o', '--outdir', dest='outdir',
                        action='store', default=NEED_DEFAULT_VALUE_HERE,
...
def main():
    ...
    # when the thing runs using our functions, delete following lines and uncomment the last line to use our own parsing function.
